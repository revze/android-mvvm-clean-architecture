...
object ActivityConstant {
    ...
    object GamesDetailActivity {
        const val ACTIVITY = "com.example.feature_games.presentation.GamesDetailActivity"
        const val GAMES_NAME = "games_name"
        const val GAMES_ID = "games_id"
    }

    object ArticleDetailActivity {
        const val ACTIVITY = "com.example.feature_article.presentation.ArticleDetailActivity"
